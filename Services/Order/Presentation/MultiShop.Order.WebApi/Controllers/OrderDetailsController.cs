...
namespace MultiShop.Order.WebApi.Controllers
{
    ...
    public class OrderDetailsController : ControllerBase
    {
        ...
        public OrderDetailsController(GetOrderDetailQueryHandler queryHandler, GetOrderDetailByIdQueryHandler getOrderDetailByIdQueryHandler, CreateOrderDetailCommandHandler createOrderDetailCommandHandler, UpdateOrderDetailCommandHandler updateOrderDetailCommandHandler, RemoveOrderDetailCommandHandler removeOrderDetailCommandHandler)
        {
