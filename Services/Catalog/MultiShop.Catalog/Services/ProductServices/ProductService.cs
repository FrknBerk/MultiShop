...
namespace MultiShop.Catalog.Services.ProductServices
{
    public class ProductService : IProductService
    {
        ...
        public async Task<GetByIdProductDto> GetByProductIdProductAsync(string id)
        {
        ...
        public async Task<List<ResultProductsWithCategoryDto>> GetProductcWithCategoryAsync()
        {
            ...
            foreach (var item in values)
            {
                ...
                item.Brand = await _brandCollection.Find<Brand>(x => x.BrandId == item.BrandId).FirstAsync();
            }
        ...
        {
            var values = await _productCollection.Find(x => x.Id == Guid.Parse(id)).FirstOrDefaultAsync();
            return _mapper.Map<GetByIdProductDto>(values);
        }
    }
}
